...
import AccountWarranty from "@/components/otherPages/AccountWarranty";
    ...
    <>
        ...
        <main className="page-wrapper">
          ...
          <section className="my-account container">
            <h2 className="page-title">Warranty Card</h2>
            <div className="row">
              <DashboardSidebar entityData={storeEntityIds} seoData={seoData}/>
              <AccountWarranty entityData={storeEntityIds} seoData={seoData}/>
            </div>
          </section>
        </main>
