...
import AccountJourney from "@/components/otherPages/AccountJourney";
    ...
    <>
        ...
        <main className="page-wrapper">
          ...
          <section className="my-account container">
            <h2 className="page-title">Journey Catalogue</h2>
            <div className="row">
              <DashboardSidebar entityData={storeEntityIds} seoData={seoData}/>
              <AccountJourney entityData={storeEntityIds} seoData={seoData}/>
            </div>
          </section>
        </main>
