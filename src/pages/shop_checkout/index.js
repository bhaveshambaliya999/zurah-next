...
export default function ShopCartPage({ storeEntityIds, seoData }) {
  return (
    <>
        <Head>
        ...
        <main className="page-wrapper">
          ...
          <section className="my-account container">
            ...
            <div className="row">
              <ChectoutSteps entityData={storeEntityIds} seoData={seoData}/>
              <Checkout entityData={storeEntityIds} seoData={seoData}/>
            </div>
          </section>
        </main>
