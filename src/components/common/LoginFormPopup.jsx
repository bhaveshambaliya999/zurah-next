      ...
      <div className="customer-forms__wrapper d-flex position-relative">
        <div className="customer__login">
          <div className="aside-header d-flex align-items-center">
            ...
            <button className="btn-close-lg js-close-aside ms-auto" aria-label={"Close login"}></button>
          </div>
          {/* <!-- /.aside-header --> */}
        ...
        <div className="customer__register">
          <div className="aside-header d-flex align-items-center">
            ...
            <button className="btn-close-lg js-close-aside btn-close-aside ms-auto" aria-label={"close modal"}></button>
          </div>
          {/* <!-- /.aside-header --> */}
